...
namespace PathPointer
{
    public partial class TimeSpent : Form
    {
        ...
        private void UpdateMainMenuDGV() {
            int hour = DateTime.Now.Hour - currentRange;
            int dayOfWeek = 6;
            if (hour < 0) {
                hour = 24 - hour;
                dayOfWeek = 5;
            ...
            mainManu.DataGridDayOfWeek.CurrentCell = mainManu.DataGridDayOfWeek[dayOfWeek, 0];
            mainManu.DataGridDayOfWeek_CellClick(null, null);
            mainManu.DataGridBusiness.CurrentCell = mainManu.DataGridBusiness[hour, 0];
